...
with gr.Blocks() as demo:
    gr.Markdown("# SAM-Diffusion: Stable Diffusion + Segment Anything Model")
    gr.Markdown(
        """
...
if __name__ == "__main__":
    demo.queue(max_size=10).launch(debug=True, share=True, server_name="0.0.0.0", server_port=5020)
